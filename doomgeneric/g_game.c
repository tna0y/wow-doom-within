...
{ 
	...
	{ 
	    ...
	    DG_memcpy(cmd, &netcmds[i], sizeof(ticcmd_t));
...
{ 
    ...
    DG_memcpy (frags,players[player].frags,sizeof(frags)); 
    ...
    DG_memcpy (players[player].frags, frags, sizeof(players[player].frags)); 
...
//#endif
	...
	DG_memcpy (wminfo.plyr[i].frags, players[i].frags 
...
static void IncreaseDemoBuffer(void)
{
    ...
    DG_memcpy(new_demobuffer, demobuffer, current_length);
